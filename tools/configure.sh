# Copyright (c) 2013 The re2c Authors. All rights reserved.
...
case "$TARGET_OS" in
    ...
    Darwin)
        ...
        PLATFORM_SHARED_LDFLAGS="-dynamiclib -single_module -undefined dynamic_lookup -install_name $INSTALL_PATH/"
        ;;
    Linux)
        PLATFORM=OS_LINUX
        CXX_LD=$CXX
